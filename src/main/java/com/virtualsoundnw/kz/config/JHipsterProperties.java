package com.virtualsoundnw.kz.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "kz@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "kz API";

        private String description = "kz API documentation";
